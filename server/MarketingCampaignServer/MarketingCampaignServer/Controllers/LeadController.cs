...
namespace MarketingCampaignServer.Controllers
{
    ...
    public class LeadController : ControllerBase
    {
        ...
        // ✅ GET: api/lead?campaignId=1&segment=General&search=diby&page=1&pageSize=20
        [HttpGet]
        ...
        // ✅ POST: api/lead (Auto segment assignment happens automatically)
        [HttpPost]
        ...
        // 🔍 OPTIONAL: Check what segment a new lead will get before creation
